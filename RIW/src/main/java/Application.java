import index.BooleanSearch;
import model.InverseIndexEntry;
import model.utils.DocumentAppearancesPair;
import repository.DirectIndexRepository;
import repository.InverseIndexRepository;
...
import static index.IndexUtils.*;
import static utils.FileUtils.printHeader;
...
//        HTMLUtils.displayHTMLInfo();
        ...
        System.out.println(printHeader("Direct index intermediate files written in " + FileUtils.DIRECT_INTERMEDIATE_PATH));
        writeIntermediateFilesInverseIndex(directIndex);
        System.out.println(printHeader("Inverse index intermediate files written in " + FileUtils.INVERSE_INTERMEDIATE_PATH));
        writeInverseIndex(directIndex);
        System.out.println(printHeader("Inverse index written in "+FileUtils.INVERSE_INDEX_PATH));
        ...
        System.out.println(printHeader("Read index length: "+inverseIndex.keySet().size()));
